...
#define MyAppName "Wend"
#define MyAppPublisher "2022 Wend developers"
#define MyAppURL "https://wellnode.online/"
#define MyAppExeName "wend-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/WEND/bootstrap.zip"
...
[Files]
Source: ".\package\wend-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Wend\Wend-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Wend\Wend-Qt,strDataDir|{userappdata}\Wend\}');
  Result := True;
end;
