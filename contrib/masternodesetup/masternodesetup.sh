...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='wend.conf'
CONFIGFOLDER='/root/.wend'
COIN_DAEMON='wendd'
COIN_CLI='wend-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/WendBF/Wend/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
