...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/wendd.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/wend-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/wend-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/wend.ico %{buildroot}%{_datadir}/pixmaps/wend.ico
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wend16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wend32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wend64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wend128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wend256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/wend256.png %{buildroot}%{_datadir}/pixmaps/wend16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/wend256.png %{buildroot}%{_datadir}/pixmaps/wend32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/wend256.png %{buildroot}%{_datadir}/pixmaps/wend64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/wend256.png %{buildroot}%{_datadir}/pixmaps/wend128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/wend256.png %{buildroot}%{_datadir}/pixmaps/wend256.xpm
