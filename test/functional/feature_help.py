...
"""Verify that starting wend with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wend with -? for help text")
        ...
        self.log.info("Start wend with -version for version information")
