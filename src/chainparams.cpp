...
{
    const char* pszTimestamp = "Make Masternode Great Again shall we...";
    const CScript genesisOutputScript = CScript() << ParseHex("04eef0a2d771f1987c82f634e6539488f9d3245387caf8544b1e79a29b9f1742451bc143f87477b62eba2973f34478c57353e136e65a2fe40e9d5404fd7c28e8f8") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1683523353, // * UNIX timestamp of last checkpoint block
...
/*
        ...
        // /////////////////////////////////////////////////////////////////
         ...
         uint32_t nGenesisTime = 1683523353;
         arith_uint256 test;
         bool fNegative;
         bool fOverflow;
        ...
        // /////////////////////////////////////////////////////////////////
*/
        genesis = CreateGenesisBlock(1683523353, 1461358, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000cbb5ec3e0c788851c37d6cf8721d8c9a5f4e4f5c4a277d83f8bf73268a9"));
        assert(genesis.hashMerkleRoot == uint256S("0xbe09fb91f78a72624bcebb8db2fa7074fe55fae09872d6e710bf80a6456b3a49"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04c08f528aef489775b9fb2a4ac1785ec043a1223a2f0ce3d0b58e359fee6a55c4cd1101739df7abfedc31e7ffd608e18fe8bc87478b0b0f76b83950b5f87b34b4";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.wellnode.online"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.wellnode.online"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.wellnode.online"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.wellnode.online"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.wellnode.online"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.wellnode.online"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.wellnode.online"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.wellnode.online"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 73);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 53);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 31);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xf9)(0xc8)(0xb9)(0x5c).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xf9)(0xc3)(0x64)(0x4c).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x49)(0x5b)(0x92).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // wend starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet wend addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet wend script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet wend BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet wend BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet wend BIP44 coin type is '1' (All coin's testnet default)
