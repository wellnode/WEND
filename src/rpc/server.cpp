...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WEND features */
        {"wend", "listmasternodes", &listmasternodes, true },
        {"wend", "getmasternodecount", &getmasternodecount, true },
        {"wend", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"wend", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"wend", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"wend", "masternodecurrent", &masternodecurrent, true },
        {"wend", "startmasternode", &startmasternode, true },
        {"wend", "createmasternodekey", &createmasternodekey, true },
        {"wend", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"wend", "listmasternodeconf", &listmasternodeconf, true },
        {"wend", "getmasternodestatus", &getmasternodestatus, true },
        {"wend", "getmasternodewinners", &getmasternodewinners, true },
        {"wend", "getmasternodescores", &getmasternodescores, true },
        {"wend", "preparebudget", &preparebudget, true },
        {"wend", "submitbudget", &submitbudget, true },
        {"wend", "mnbudgetvote", &mnbudgetvote, true },
        {"wend", "getbudgetvotes", &getbudgetvotes, true },
        {"wend", "getnextsuperblock", &getnextsuperblock, true },
        {"wend", "getbudgetprojection", &getbudgetprojection, true },
        {"wend", "getbudgetinfo", &getbudgetinfo, true },
        {"wend", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"wend", "mnfinalbudget", &mnfinalbudget, true },
        {"wend", "checkbudgets", &checkbudgets, true },
        {"wend", "mnsync", &mnsync, true },
        {"wend", "spork", &spork, true },
        {"wend", "getcollateral", &getcollateral, true},
...
{
    return "> wend-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50313/\n";
}
