...
bool CheckBlockSignature(const CBlock& block, const bool enableP2PKH)
{
    ...
    /** Each block is signed by the private key of the input that is staked. This can be either zWEND or normal UTXO
     *  zWEND: Each zWEND has a keypair associated with it. The serial number is a hash of the public key.
