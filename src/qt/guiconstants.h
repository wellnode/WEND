...
/* Wend GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Wend"
#define QAPP_ORG_DOMAIN "wellnode.online"
#define QAPP_APP_NAME_DEFAULT "Wend-Qt"
#define QAPP_APP_NAME_TESTNET "Wend-Qt-testnet"
