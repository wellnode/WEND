Contributing to Wend Core
============================

The Wend Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/WendBF/Wend/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Wend Core project, and is not to be
confused with overall Wend Network Protocol consensus changes.

Whether a pull request is merged into Wend Core rests with the project merge
...
Patches that change Wend consensus rules are considerably more involved than
...
Where a patchset proposes to change the Wend consensus, it must have been
...
The project leader is the release manager for each Wend Core release.
