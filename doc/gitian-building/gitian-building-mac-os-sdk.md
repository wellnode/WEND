...
The script [extract-osx-sdk.sh](https://github.com/WendBF/Wend/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/WendBF/Wend/blob/master/doc/README_osx.md) for troubleshooting tips.