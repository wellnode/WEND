...
* Update manpages, see [gen-manpages.sh](https://github.com/WendBF/Wend/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/WendBF/Wend-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/WendBF/Wend.git
